PLUGIN.Name = "Bliss Faction Templates"; -- What is the pugin name
...
function CAKE.BlissFaction( name, founder, ranks, flags, doorgroup, buygroups, image, tags )
