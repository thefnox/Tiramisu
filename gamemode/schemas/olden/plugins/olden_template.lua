PLUGIN.Name = "Olden Faction Templates"; -- What is the pugin name
...
function CAKE.OldenFaction( name, founder, ranks, flags, doorgroup, buygroups, image, tags )
