...
function RCLICK.Click(target,ply)
	...
	TextEntry.OnEnter = function() Window:Close() ply:ConCommand("rp_admin converttoitem " .. target:EntIndex() .. " \"" .. TextEntry:GetValue() .. "\" " .. tostring( CheckBox:GetChecked() ) .. " " .. tostring( CheckBox2:GetChecked() ) .. " \"" .. bone .. "\"" ) print( bone )) end
	...
	Button:SetPos( 5, 5 )
	Button.DoClick = function() Window:Close() ply:ConCommand("rp_admin converttoitem " .. target:EntIndex() .. " \"" .. TextEntry:GetValue() .. "\" " .. tostring( CheckBox:GetChecked() ) .. " " .. tostring( CheckBox2:GetChecked() ) .. " \"" .. bone .. "\"" ) print( bone )) end
