...
function RCLICK.Condition(target)
	...
	if IsValid( target) and !target:GetNWBool("permaprop",false) and target:GetClass() == "prop_physics" and LocalPlayer():GetNWInt( "TiramisuAdminLevel", 0 ) > 0 then return true end
